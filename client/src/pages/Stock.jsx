        ...
        <div className="min-h-screen p-4 md:p-8">
            <div className="flex justify-between items-center mb-8">
                ...
                <button 
                    ...
                    className="bg-perru-orange hover:bg-orange-400 text-white px-6 py-3 rounded-2xl font-bold shadow-lg shadow-orange-200 transition-transform active:scale-95"
                >
                    + Nuevo Producto
                </button>
            </div>
                            ...
                            <tr key={prod.id} className="hover:bg-perru-bg/50 transition-colors">
                                ...
                                <td className="p-5">
                                    <span className={`px-3 py-1 rounded-xl text-xs font-bold uppercase ${
                                        prod.categoria === 'Alimento' ? 'bg-perru-orange/20 text-orange-600' :
                                ...
                                <td className="p-5 font-black text-gray-600">${parseFloat(prod.precio).toLocaleString()}</td>
                                <td className="p-5">
                                    <span className={`px-3 py-1 rounded-lg text-xs font-black ${
                                        prod.stock <= prod.stock_minimo ? 'bg-red-50 text-red-500 border border-red-100' : 'bg-green-50 text-green-600'
                                    }`}>
                                        {prod.stock} u.
                                    </span>
                                </td>
